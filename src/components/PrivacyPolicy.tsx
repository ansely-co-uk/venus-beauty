...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="mx-auto bg-black px-4 py-12 text-white sm:px-6 lg:px-16">
      <h1 className="mb-8 mt-15 text-center text-4xl font-semibold">
        Privacy Policy
      </h1>
      <p className="text-center text-slate-300">Last updated: 09/09/25</p>
      ...
      <div className="mt-8 space-y-6">
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 ml-6 text-slate-300">
            <li>Full name</li>
            <li>Email address</li>
            <li>Phone number</li>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 ml-6 text-slate-300">
            <li>
              Contract – to provide a quote, arrange services, or fulfill an
              agreement with you
            </li>
            <li>
              Consent – when you give us permission to contact you for specific
              purposes
            </li>
            <li>
        ...
        <section>
          ...
          <p className="mt-2 text-slate-300">We use your personal data to:</p>
          <ul className="mt-2 list-disc space-y-1 ml-6 text-slate-300">
            <li>Respond to inquiries and provide quotes</li>
            <li>Deliver Cambridge Automotive services</li>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 ml-6 text-slate-300">
            <li>
              Trusted service providers (such as IT and hosting providers) who
        ...
        <section>
          ...
          <p className="mt-2 text-slate-300">
            ...
            experience and monitor website performance. You can set your
            browser to refuse cookies if you prefer.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2 text-slate-300">
            We take appropriate measures to keep your personal information
            secure and prevent unauthorized access, disclosure, alteration, or
            destruction.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2 text-slate-300">
            We keep your personal data only for as long as necessary to fulfill
